...
library EVMFetcher {
    ...
    function getStatic(
        ...
        _addOperation(
            request,
            OP_ADD_CONST | _addConstant(request, abi.encode(baseSlot))
        );
        return request;
    }
    ...
    function element(
        ...
        _addOperation(
            request,
            OP_FOLLOW_CONST | _addConstant(request, abi.encode(el))
        );
        return request;
    }
    ...
    function element(
        ...
        _addOperation(
            request,
            OP_FOLLOW_CONST | _addConstant(request, bytes(el))
        );
        return request;
    }
    ...
    function offset(
        ...
        _addOperation(
            request,
            OP_ADD_CONST | _addConstant(request, abi.encode(off))
        );
        return request;
    }
    ...
    function fetch(
        ...
        revert OffchainLookup(
            address(this),
            request.verifier.gatewayURLs(verifierData),
            abi.encodeCall(
    ...
    function fetch(
        ...
        fetch(request, callbackId, callbackData, "");
    }
